...
```
Rely on tone to connect with the audience.
Balance simplicity with sufficient background information.
...
```
〇 How the message interacts with the intended recipients.
